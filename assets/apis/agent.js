            ...
            if (pkt.status==200){
                for(i in pkt.location){
                    ...
                    +'<div style="margin-left:-120px;margin-top:50px;">'
                        +'<div id="'+pkt.location[i].billboard_id+'" onclick="saveMap(this)" class="icon iq-icon-box-2 edit-button bg-white  rounded" style="margin-left:108px;margin-top:-50px;" title="Billboard Status">'
